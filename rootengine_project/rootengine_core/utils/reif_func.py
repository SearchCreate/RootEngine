...
from ..schema.reif_schema import REIF_SCHEMA_JSON



# import os
# HERE = os.path.dirname(os.path.abspath(__file__))
# schema_path = os.path.join(HERE,"..","schema","reif_schema.json")
# schema_path = os.path.normpath(schema_path)
# print("最终路径:", schema_path)  # 调试用
# with open(schema_path,"r",encoding='utf-8') as f:
#     REIF_SCHEMA_JSON = f.read()
...
def reif_load(reif_params,reif_content):
    ...
    reif_entry = reif_creater(reif_params)
